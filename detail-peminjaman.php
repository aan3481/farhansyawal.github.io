                ...
                <div class="container-fluid">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb my-0 ms-2">
                            ...
                            <li class="breadcrumb-item active"><span>Detail Peminjaman</span></li>
                        </ol>
                    </nav>
                </div>
            </header>
            <div class="body flex-grow-1 px-3">
                <div class="container-fluid">
                    <div class="row text-center">
                        <h1 class="mb-5">Detail Peminjaman</h1>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <table class="table table-striped">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success text-white" href="edit-detailPeminjaman.php?id=<?php echo $d['idBuku']; ?>">Edit</a>
                                                <a class="btn btn-danger text-white" href="delete-detailPeminjaman.php?id=<?php echo $d['idBuku']; ?>">Delete</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </table>
